...
public final class PreviewMoviePage extends ScrollView {
    ...
    private TextView button(String s,Runnable run){TextView t=text(s,14);t.setGravity(Gravity.CENTER);t.setPadding(dp(18),dp(10),dp(18),dp(10));t.setFocusable(true);t.setBackground(bg(false));t.setOnFocusChangeListener((v,f)->v.setBackground(bg(f)));t.setOnClickListener(v->run.run());return t;}
