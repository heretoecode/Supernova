...
public final class PreviewPages extends FrameLayout {
    ...
    private void chooseMany(String title,List<String> names,List<String> values,String saved,java.util.function.Consumer<String> accept){
