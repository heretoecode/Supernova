...
public final class PreviewTrailer {
    public static void show(Activity activity,ScraperTrailer trailer){
        ...
        web.loadDataWithBaseURL("https://"+activity.getPackageName()+"/", "<html><body style='margin:0;background:#000'><iframe width='100%' height='100%' src='https://www.youtube.com/embed/"+trailer.mVideoKey+"?playsinline=1&autoplay=1' frameborder='0' allow='autoplay; encrypted-media; fullscreen' allowfullscreen></iframe></body></html>","text/html","UTF-8",null);
    }
