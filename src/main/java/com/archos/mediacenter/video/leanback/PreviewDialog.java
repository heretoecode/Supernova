...
public final class PreviewDialog {
 ...
 public static StateListDrawable focus(Context c){StateListDrawable s=new StateListDrawable();s.addState(new int[]{android.R.attr.state_focused},new PreviewFocusUnderline(c,true));s.addState(new int[]{},new android.graphics.drawable.ColorDrawable(Color.TRANSPARENT));return s;}
