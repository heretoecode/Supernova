...
public final class PreviewAccent {
 ...
 public static GradientDrawable utility(Context c){int a=color(c);return new GradientDrawable(GradientDrawable.Orientation.TL_BR,new int[]{Color.rgb(11+Color.red(a)/18,23+Color.green(a)/18,35+Color.blue(a)/18),0xff091725});}
