...
public final class PreviewLibraryColumns {
 ...
 private android.graphics.drawable.Drawable separator(boolean vertical){android.graphics.drawable.LayerDrawable d=new android.graphics.drawable.LayerDrawable(new android.graphics.drawable.Drawable[]{new android.graphics.drawable.ColorDrawable(0x120b1b29),new android.graphics.drawable.ColorDrawable(vertical?0x28708695:0x38708695)});if(vertical){d.setLayerWidth(1,dp(1));d.setLayerGravity(1,Gravity.END);}else{d.setLayerHeight(1,dp(1));d.setLayerGravity(1,Gravity.BOTTOM);}return d;}
