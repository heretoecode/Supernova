...
final class PreviewUpNext {
 ...
 private LinearLayout panel;private TextView countdown;private long episodeId=-1,deadline;private boolean dismissed;private long lastTick;
 ...
 private void remove(){if(panel!=null&&panel.getParent() instanceof ViewGroup)((ViewGroup)panel.getParent()).removeView(panel);panel=null;}
